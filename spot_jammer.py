...
class spot_jammer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "spot_jammer")
        ...
        self.fft_vxx_0 = fft.fft_vcc(vec_len, True, window.blackmanharris(1024), True, 1)
        self.blocks_vector_sink_x_0 = blocks.vector_sink_f(1024, 1024)
...
def main(top_block_cls=spot_jammer, options=None):
